...
public class EasySlider extends RelativeLayout {
    ...
    public void setDotsBackground(int resID) {
        dots_container.setBackgroundResource(resID);
    }

    public void showDotsBackground() {
        dots_container.setBackgroundResource(R.drawable.rounded);
    }
    ...
    public void setPages(List<SliderItem> sliderItems) {
        ...
        mSectionsPagerAdapter = new SliderAdapter(((FragmentActivity) context).getSupportFragmentManager(), sliderItems, easySliderListener);
